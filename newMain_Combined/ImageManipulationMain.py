...
class mainImageManipulation: #This class will perform the main manipulation operations on the loaded image
    def __init__(self, imiManip, charSize = 5):
        ...
        self.image = self.load_image(r'C:\Users\yasht_000\Desktop\SEMESTER-4\PYTHON PROGRAMMING LAB\images\hagler3.jpg')
        #self.flag = 0
                ...
                if char:
                    ...
                    if red and green and blue: #if red/green/blue have a value, else no need to saturate or adjust the brightness of the pixelated array, else it will be left blank (because value goes into underscope)
                        ...
                        if keys[pygame.K_SPACE]:
                            ...
                            print('Saving image')
                            #self.take_screenshot()
                            pygame.image.save(self.imiManip.screen, r'C:\Users\yasht_000\Desktop\SEMESTER-4\PYTHON PROGRAMMING LAB\output\Manipulated_Image.png')
                            break
                            #self.take_screenshot()
                            #self.take_screenshot()
                            #pass
    ...
    def take_screenshot(self):
        save_image = pygame.image.save(self.imiManip.screen, r'C:\Users\yasht_000\Desktop\SEMESTER-4\PYTHON PROGRAMMING LAB\output\Filtered_Image.png')
        return
...
class initializeImage: #This class will initialize, load and call the manipulation operations from the mainImageManipulation Class
    ...
    def execute(self): #Getter method
        ...
        t15 = self.buttonFont.render('[Hold SPACE to save image]', True, (255, 255, 255))
        t16 = self.buttonFont.render('[Press ESC to quit]', True, (255, 255, 255))
        ...
        while True:
            ...
            self.screen.blit(t9, (self.width - self.width + 10, self.height - self.height + 130))
            self.screen.blit(t10, (self.width - self.width + 10, self.height - self.height + 145))
            self.screen.blit(t11, (self.width - self.width + 10, self.height - self.height + 160))
            self.screen.blit(t12, (self.width - self.width + 10, self.height - self.height + 175))
            self.screen.blit(t13, (self.width - self.width + 10, self.height - self.height + 190))
            self.screen.blit(t14, (self.width - self.width + 10, self.height - self.height + 205))
            self.screen.blit(t15, (self.width - 200, self.height - self.height + 10))
            self.screen.blit(t16, (self.width - 150, self.height - self.height + 45))
